 ...
 */
export const self_grammar: Parser<any> = memoize(
  sequence(
    literal("grammar"),
    self_identifier,
    literal("{"),
...
export const self_primary_atom: Parser<any> = memoize(
  choice(
    self_string_literal,
...
export const self_character_class: Parser<any> = memoize(
  sequence(literal("["), self_char_content, literal("]")),
);
...
export const self_identifier: Parser<any> = memoize(
  sequence(self_ident_start, zeroOrMore(self_ident_continue)),
);
// contains recursionexport const self_ident_start: Parser<any> = charClass([{ from: "a", to: "z" }, { from: "A", to: "Z" }, "_"]);
export const self_ident_continue: Parser<any> = charClass([
  { from: "a", to: "z" },
  { from: "A", to: "Z" },
  { from: "0", to: "9" },
  "_",
]);
export const self_number: Parser<any> = oneOrMore(
  charClass([{ from: "0", to: "9" }]),
);
